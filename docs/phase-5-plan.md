...
| D80 | **Ölçüm tabanı değiştiğinde kapı eşikleri yeni taban üzerinde yeniden kurulur**; eski profil tabanıyla birlikte `supersededProfiles` altında arşivlenir. Üç koruma: (1) yeni eşik **ölçülür, seçilmez** — iyi olan motorun (bugün legacy) ölçülmüş değeri, aşağı yuvarlanmadan; (2) eski profil silinmez, denetlenebilir kalır; (3) **D77 taban içinde aynen geçerlidir** — yeniden kurulduktan sonra eşikler yalnızca yukarı. | Eşik, *aynı ölçümün* tekrarları hakkında bir iddiadır. R5.0d ground truth'u 160 → 288 kayda çıkarınca ölçüm değişti: %92,5 artık daha sıkı bir çıta değil, **başka bir çıta**. Yeni tabanda legacy %89,93, lattice %58,33 — hiçbir motor geçemiyor, yani kapı kalıcı kırmızı ve R5.4b'nin yeşil hedefi yok. D77 gevşetmeyi yasaklamak için kondu ve o amaç geçerli; ama taban değişimini gevşetme saymak, **doğru ölçüme geçmeyi cezalandırır**. Yeniden kurulmuş kapı lattice için "legacy'ye yetiş" koşuluna dönüşür — Faz 5'in hedefinin tam olarak kendisi. | Kuyruk bölüm 2b, 2c; kalem R5.0f |
